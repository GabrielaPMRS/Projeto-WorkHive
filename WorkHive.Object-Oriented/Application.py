...
class Application():
    def __init__(self):
        ...
        self.ads_dict = {
            1: OfferAd('Gabi', 'tecnologia', 'crio sites', '15000'),
            2: LookingForAd('Gabi', 'Marcenaria', 'mesas artesanais'),
            3: OfferAd('Lara', 'Hidráulico', 'conserto canos', '45'),
            4: LookingForAd('Lara', 'eletricista', 'crio tomadas'),
        }
    ...
    def start(self):
        while True:
            if self.logged_username == None:
                ...
                print('4 para criar um anúncio de oferta de serviço')
                print('5 para criar um anúncio de busca de serviço')
                print('6 para deletar um anúncio')
                print('7 para mostrar anúncios existentes.')
                print('8 para favoritar um anúncio.')
                print('9 para mostrar lista de favoritos de um usuário.')
                print('10 para escrever um feedback.')
                print('11 para listar os feedbacks de um usuário.')
                print('12 para listar os feedbacks de um anúncio.')
                print('13 para ver suas notificações.')
                print('14 para enviar um email ao prestador de serviço.')
                ...
                if option == 1:
                    ...
                    category = input('Qual a categoria do serviço ofertado? ')
                    ...
                    ad_id = user.create_OfferAd(self.ads_dict, category, description, price)
                    ...
                    user = self.users[self.logged_username]
                    category = input('Qual a categoria do serviço que busca? ')
                    description = input('Descreva o serviço: ')

                    ad_id = user.create_LookingForAd(self.ads_dict, category, description)
